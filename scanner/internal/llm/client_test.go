...
// INTELLIRECON_LLM matches Legacy_Provider_Shape, Resolve must dispatch
...
// INTELLIRECON_LLM names a legacy slug. The test asserts the URL,
...
// INTELLIRECON_LLM does not match Legacy_Provider_Shape, Resolve must
