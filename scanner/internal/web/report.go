...
func (s *Server) generateReport(scan *ScanRecord) (string, error) {
	...
	pdf.SetFont("Helvetica", "B", 10)
	setColor(white)
	pdf.CellFormat(182, 5, "IntelliRecon", "", 1, "L", false, 0, "")
	...
	setColor(white)
	pdf.SetX(10)
	pdf.MultiCell(190, 4.5, "IntelliRecon follows a comprehensive 22-phase penetration testing methodology "+
	...
	disclaimer := `This penetration test was conducted by IntelliRecon, an autonomous AI-powered security assessment tool. The findings in this report are based on automated testing and manual verification where possible.
...
* False Positives: While IntelliRecon attempts to verify findings before reporting, some findings may require manual validation. We recommend validating all critical and high-severity findings before taking remediation actions.
...
Generated by IntelliRecon - Autonomous AI Pentesting Engine
https://github.com/intellirecon/intellirecon`
	...
	filename := fmt.Sprintf("intellirecon_report_%s.pdf", reportID)
