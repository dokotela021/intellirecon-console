// Package proxy provides HTTP, HTTPS and SOCKS5 proxy support for IntelliRecon.
...
func NewDirectClient(tlsSkipVerify bool) *http.Client {
	...
	if tlsSkipVerify {
		...
		tr.TLSClientConfig.InsecureSkipVerify = true //nolint:gosec // controlled by INTELLIRECON_TLS_SKIP_VERIFY
	}
	return &http.Client{
		Transport: tr,
