// content.js — IntelliRecon Page Agent content script.
...
(() => {
  ...
  if (window.__intellirecon_content_loaded) return;
  window.__intellirecon_content_loaded = true;
  ...
  console.log("[intellirecon-content] Page agent loaded on", window.location.href);
})();
