...
import (
	...
	"intellirecon-scanner/internal/tools/agentmail"
	"intellirecon-scanner/internal/tools/agentsgraph"
	"intellirecon-scanner/internal/tools/browser"
	"intellirecon-scanner/internal/tools/codesearch"
	"intellirecon-scanner/internal/tools/fileedit"
	"intellirecon-scanner/internal/tools/finish"
	"intellirecon-scanner/internal/tools/httpclient"
	"intellirecon-scanner/internal/tools/notes"
	oobtool "intellirecon-scanner/internal/tools/oob"
	"intellirecon-scanner/internal/tools/pageagent"
	"intellirecon-scanner/internal/tools/proxy"
	"intellirecon-scanner/internal/tools/python"
	"intellirecon-scanner/internal/tools/reporting"
	skillstool "intellirecon-scanner/internal/tools/skills"
	"intellirecon-scanner/internal/tools/terminal"
	"intellirecon-scanner/internal/tools/websearch"
)
...
func (a *Agent) Run(targets []string, instruction string) {
	...
	for iter := 0; (a.maxIter == 0 || iter < a.maxIter) && !a.stopped.Load() && (a.ctx == nil || a.ctx.Err() == nil); iter++ {
		...
		// could otherwise blow past INTELLIRECON_MAX_TOOL_CALLS. Truncate the batch
