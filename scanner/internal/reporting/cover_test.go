...
func TestCoverPage_FreePlanWatermarkPresent(t *testing.T) {
	...
	const watermarked = "TRIAL — INTELLIRECON FREE — Acme Corp"
	body, _ := renderFixture(t, fixedScan(watermarked))

	// "TRIAL" and "INTELLIRECON FREE" are ASCII substrings of the
	...
	for _, marker := range []string{"TRIAL", "INTELLIRECON FREE"} {
