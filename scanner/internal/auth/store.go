...
// editable credential store at ~/.intellirecon/data/auth-profiles.json.
//
...
import (
	...
	"intellirecon-scanner/internal/storage"
)
...
func (s *Store) withLock(fn func() error) error {
	...
	// file in ~/.intellirecon/data as private to the dashboard
	// owner.
