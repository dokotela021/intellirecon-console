...
//     INTELLIRECON_<UPPER_ID>_OAUTH_CLIENT_ID at runtime.
package providers
...
var builtinList = []Entry{
	...
	},
	{
		...
		// client IDs. Operators set INTELLIRECON_GOOGLE_OAUTH_CLIENT_ID
		// (read at lookup time by ClientIDForEntry).
		AuthorizationEndpoint: "https://accounts.google.com/o/oauth2/v2/auth",
		TokenEndpoint:         "https://oauth2.googleapis.com/token",
		Scopes:                []string{"https://www.googleapis.com/auth/cloud-platform"},
		Models:                []string{"gemini-2.5-pro", "gemini-2.5-flash"},
		Notes:                 "Set INTELLIRECON_GOOGLE_OAUTH_CLIENT_ID to your Google Cloud OAuth client.",
	},
	{
		ID:          "googlevertex",
...
// ClientIDForEntry returns the OAuth client ID IntelliRecon should use
// for the given entry. Operators can override the compiled-in
// default with the env var INTELLIRECON_<UPPER_ID>_OAUTH_CLIENT_ID
// (e.g. INTELLIRECON_GOOGLE_OAUTH_CLIENT_ID for the "google" slug).
