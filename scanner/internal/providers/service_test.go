...
// INTELLIRECON_<UPPER_ID>_OAUTH_CLIENT_ID escape hatch wins over the
...
func TestClientIDForEntry_EnvOverride(t *testing.T) {
	...
	t.Run("default empty when env unset", func(t *testing.T) {
		t.Setenv("INTELLIRECON_GOOGLE_OAUTH_CLIENT_ID", "")
	...
	t.Run("env override wins", func(t *testing.T) {
		t.Setenv("INTELLIRECON_GOOGLE_OAUTH_CLIENT_ID", "operator-supplied-client-id")
	...
	t.Run("compiled-in default when env unset and ClientID present", func(t *testing.T) {
		t.Setenv("INTELLIRECON_COPILOT_OAUTH_CLIENT_ID", "")
