    ...
    >
      <DialogContent className="max-w-xl">
        <DialogHeader>
          ...
          <DialogDescription>
            intellirecon will store the resulting credential under
        ...
        {!expired &&
          ...
          !startResult.authURL && (
            <div className="space-y-3 rounded-md border border-border bg-muted/30 p-4 text-sm">
              <p>
                intellirecon will read the credential file already present on
  ...
  return (
    <div className="space-y-3 rounded-md border border-border bg-muted/30 p-4 text-sm">
      <p>
        ...
        on this host and intellirecon will persist the credential automatically.
      </p>
      {startResult.authURL && (
        <a
  ...
  return (
    <div className="space-y-3 rounded-md border border-border bg-muted/30 p-4 text-sm">
      <p>
        ...
        below. intellirecon is polling the provider for completion.
      </p>
